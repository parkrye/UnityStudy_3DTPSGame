...
public class PoolManager : MonoBehaviour
{
    ...
    public T Get<T>(T original, Vector3 position, Quaternion rotation, Transform parent) where T : Object
    {
        ...
        {
            Component comp = original as Component;
            string key = comp.name;
            if(!poolContainer.ContainsKey(key))
                CreatePool(key, comp.gameObject);
    ...
    public bool Release<T>(T instance) where T : Object
    {
        ...
        else if (instance is Component)
        {
            ...
            poolDic[key].Release(comp.gameObject);
            return true;
        }
        return false;
    }
